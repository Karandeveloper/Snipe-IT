    ...
    <header class="navbar navbar-inverse" role="banner">
	    <div class="navbar-header">
            <button class="navbar-toggle" type="button" data-toggle="collapse" id="menu-toggler">
	            ...
	            @else
	            	<a class="navbar-brand" href="http://itaseest.com/">
	            	{{{ Setting::getSettings()->site_name }}}
	            	</a>
	            @endif
        </div>
    ...
    <div id="sidebar-nav">
        <ul id="dashboard-menu">
			...
			<li{{ (Request::is('*/') ? ' class="active"><div class="pointer"><div class="arrow"></div><div class="arrow_border"></div></div>' : '>') }}
                <a href="http://itaseest.com/"><i class="fa fa-dashboard"></i><span>@lang('general.dashboard')</span></a>
            </li>
    ...
    <footer>
        ...
        <div id="footer" class="col-md-offset-2 col-md-9 col-sm-12 col-xs-12 text-center">
		                <div class="muted credit hidden-xs">
	                  			<a target="_blank" href="http://karandeveloper.com">Karandeveloper</a> All Customization by 
					  			<a target="_blank" href="http://twitter.com/karanmankodiya">@karandeveloper</a>.
